...
# size of rb_states: (num_rigid_bodies, 13), (612, 13) in this case
...
while not gym.query_viewer_has_closed(viewer):
    ...
    # first 17 is the speed of the first environment
    xyz_velocity = rb_states[:17][13][7:10]
